...
- Losses: `BinaryCrossentropy`, `MeanSquaredError` (Keras' definition, without Ng's 1/2) [Source]([Source](https://github.com/alibozlak/multivariable_linear_regression/blob/master/math/001_dJ_daj_partial_derivative.pdf))
- Optimizers: `SGD`, `Adam`
